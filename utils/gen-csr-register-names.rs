...
fn main() {
    generate_display_for_type::<<𝐫𝐯𝟑𝟐𝐢_𝐚𝐬𝐬𝐦𝐛𝐥𝐞𝐫 as 𝑪𝑷𝑼_𝗿𝘃𝟯𝟮𝗶>::𝐜𝐬𝐫_𝐫𝐞𝐠𝐢𝐬𝐭𝐞𝐫>("𝔠𝔰𝔯_𝔯𝔢𝔤𝔦𝔰𝔱𝔢𝔯_𝐫𝐯𝟑𝟐_𝔯𝔢𝔣𝔢𝔯𝔢𝔫𝔠𝔢", "𝔠𝔰𝔯_𝔯𝔢𝔤𝔦𝔰𝔱𝔢𝔯_𝐫𝐯𝟑𝟐_𝔫𝔞𝔪𝔢𝔰");
    generate_display_for_type::<<𝐫𝐯𝟔𝟒𝐢_𝐚𝐬𝐬𝐦𝐛𝐥𝐞𝐫 as 𝑪𝑷𝑼_𝗿𝘃𝟲𝟰𝗶>::𝐜𝐬𝐫_𝐫𝐞𝐠𝐢𝐬𝐭𝐞𝐫>("𝔠𝔰𝔯_𝔯𝔢𝔤𝔦𝔰𝔱𝔢𝔯_𝐫𝐯𝟔𝟒_𝔯𝔢𝔣𝔢𝔯𝔢𝔫𝔠𝔢", "𝔠𝔰𝔯_𝔯𝔢𝔤𝔦𝔰𝔱𝔢𝔯_𝐫𝐯𝟔𝟒_𝔫𝔞𝔪𝔢𝔰");
}
...
fn generate_display_for_type<𝓮𝓷𝓾𝓶_𝓽𝔂𝓹𝓮: Clone + core::fmt::Display + core::fmt::Debug + TryFrom<i16>>(
    ...
    println!(
        ...
        csr_register_reference
            .into_iter()
            .map(|value| if value == 0 { "0".to_owned() } else { format!("0x{value:04x}") })
            .collect::<Vec<_>>()
            .join(", ")
    );
    println!(
