...
INSERT INTO traits_information VALUES('generic_assembler_operand','address_32bit_memory_226bit');
...
INSERT INTO operand VALUES('Mdq','rm','address_16bit_memory_128bit','legacy',NULL,NULL);
INSERT INTO operand VALUES('Mdq','rm','address_32bit_memory_128bit',NULL,NULL,NULL);
INSERT INTO operand VALUES('Mdq','rm','address_64bit_memory_128bit','x86_64',NULL,NULL);
INSERT INTO operand VALUES('Mdq','rm','norex_address_32bit_memory_128bit','x86_64',NULL,NULL);
INSERT INTO operand VALUES('Mdq','rm','norex_address_64bit_memory_128bit','x86_64',NULL,NULL);
...
INSERT INTO operands VALUES('Mdq','Mdq',NULL,NULL,NULL,NULL);
...
CREATE TABLE instruction (
    ...
    operands TEXT CHECK ( -- operands. See “AMD64 ArchitectureProgrammer’s Manual. Volume 3.”
        ...
        operands IN (
            ...
            'Mdq',         -- e.g. cmpxchg16b OWORD PTR [ebx]
...
INSERT INTO instruction VALUES('cmpxchg16b','Mdq','x86_64',NULL,'data_size_prefix_64bit',NULL,'secondary',0xc7,1,'cmpxchg16b');
